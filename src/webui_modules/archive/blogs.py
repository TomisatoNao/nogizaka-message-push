...
from src.webui_modules.archive.blog_backfill import handle_group_backfill, handle_member_backfill
    ...
    if sub.startswith("blog_media/"):
        ...
        if qp("thumb").lower() in ("1", "true", "yes"):
            ...
            if thumb_path and thumb_path.is_file():
                ...
                return True
        serve_file_range(handler, full, cache_control="public, max-age=31536000, immutable")
        return True
