...
def test_archive_home_static_asset_version_bumped():
    ...
    assert "/static/archive.js?v=20260919_3" in html
    assert "/static/archive.css?v=20260919_3" in html
    assert "/static/archive.js?v=20260919_3" in perf
    assert "/static/archive.css?v=20260919_3" in perf
